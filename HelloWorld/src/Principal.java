...
import calculos.Exponenciacao;
import calculos.FatorDesconto;
import calculos.Fatorial;
import calculos.Fibonacci;
import calculos.MaiorMenor;
import calculos.MediaFatec;
import calculos.Numeros;
import calculos.Palindromo;
import jogos.JogoMoeda;
...
//		obj.exibir();
		...
		do{
			...
			case "j":
				...
				JOptionPane.showMessageDialog(null, "Ler n�meros digitados pelo Usuúrio (Exibe Maior Menor)");
				...
				do {
					...
					case "c":
						...
						valorMultiplicador = Integer.parseInt(
								JOptionPane.showInputDialog("Digite o número multiplicador:"));
					...
					default:
						JOptionPane.showMessageDialog(null, "Opçãoo incorreta!");
						break;
					}
			...
			case "m":
				...
				do {
					opcaoQuadrado = JOptionPane.showInputDialog("Deseja calcular:\n"
							+ "a. Area\n"
							+ "b. Perímetro\n\n"
							+ "Digite a opçãoo desejada ou s para voltar:");
			...
			case "s":
				...
				qtdLancamentos = Integer.parseInt(JOptionPane.showInputDialog("Quantas vezes a moeda será lançada? \n\nDigite um número inteiro..."));
				
				JogoMoeda objMoeda = new JogoMoeda(qtdLancamentos);
